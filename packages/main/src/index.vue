<script>
    ...
    export default {
        ...
        emits: ["enter","chat-click","chat-remove"],
        setup(props, ctx) {
            // 会话框组件集合
            const panes = ref([]);
        ...
        methods: {
            ...
            handleTabClick(pane) {
                ...
                this.$emit("chat-click",pane.chat);
            },
            // 处理会话标签删除事件
            handleTabRemove(pane) {
                this.$emit("chat-remove",pane.chat);
            },
            // 发送消息
